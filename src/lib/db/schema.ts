...
export const accounts = pgTable(
  "accounts",
  {
    ...
    // Snake-case keys (not this file's usual camelCase) because
    // @auth/drizzle-adapter's `DefaultPostgresAccountsTable` type requires
    // these exact property names to structurally match `AdapterAccount`.
