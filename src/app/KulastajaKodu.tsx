...
/**
 * The signed-out marketing home page — lives in its own module (rather
 * than inside `page.tsx`, which Next.js restricts to a fixed export
 * surface) so it can be rendered directly in a plain synchronous unit
 * test, with no dependency on next-auth.
 */
export function KulastajaKodu() {
